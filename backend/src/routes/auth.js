...
// ROUTE: 2 => Authenticate a User with Email & Password: POST '/api/auth/login'.
router.post('/login', [
    body('email', 'Enter a valid email address').isEmail(),
    body('password', 'Enter a valid password').isStrongPassword()
], async (req, res, next) => {
...
// ROUTE: 3 => Send Forgot Password OTP: POST '/api/auth/forgot-password/otp/send'
...
// ROUTE: 4 => Verify Forgot Password OTP: POST '/api/auth/forgot-password/otp/verify'
...
// ROUTE: 5 => Reset Password: POST '/api/auth/forgot-password/reset-password'
