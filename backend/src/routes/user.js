...
// ROUTE: 1 => Authenticate user by JWT Token: GET '/api/user/authenticate'
...
// ROUTE: 2 => Get user data: GET '/api/user/get'
...
// ROUTE: 3 => Update Name: PATCH '/api/user/update/name'
...
// ROUTE: 4 => Delete User: DELETE '/api/user/delete'
